        ...
        <div class="header w-full flex items-center justify-between mb-12 animate-slide-up">
            <div class="flex gap-8 items-center">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <p class="text-[#7F8190] font-bold text-lg uppercase tracking-widest">Editing Question</p>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div v-for="(answer, index) in form.answers" :key="index" 
                            ...
                            <label class="cursor-pointer relative flex items-center font-poppins text-poppins">
                                <input
