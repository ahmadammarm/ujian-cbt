    ...
    <AdminLayout>
        <div class="flex flex-col gap-10 px-5 mt-5 text-sm">
            <div class="breadcrumb flex items-center gap-[30px]">
                <Link :href="route('dashboard')" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Home</Link>
                <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                <Link :href="route('dashboard.courses.index')" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Manage Courses</Link>
                <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                <Link :href="route('dashboard.courses.show', course.id)" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Course Details</Link>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5 pb-10">
            ...
            <button type="submit" :disabled="form.processing" class="w-[500px] h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center disabled:opacity-50">Save Question</button>
        </form>
    </AdminLayout>
</template>
