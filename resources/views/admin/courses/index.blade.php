                ...
                @forelse($courses as $course)
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        ...
                        @elseif($course->category->name == 'Design')
                            <div class="flex shrink-0 w-[170px] items-center justify-center">
                                <p class="p-[8px_16px] rounded-full bg-[#FDEBEA] font-bold text-sm text-[#FD445E]">
                                    {{ $course->category->name }}
                                </p>
                            </div>
                        @elseif($course->category->name == 'Marketing')
                            <div class="flex shrink-0 w-[170px] items-center justify-center">
                                <p class="p-[8px_16px] rounded-full bg-[#E6F9E6] font-bold text-sm text-[#28A745]">
                                    {{ $course->category->name }}
                                </p>
                            </div>
                        @endif
